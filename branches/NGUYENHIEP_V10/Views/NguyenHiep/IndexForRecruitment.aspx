<%@ Page Title="Recruitment" Language="C#" MasterPageFile="~/Views/Shared/Site.Master" Inherits="System.Web.Mvc.ViewPage<NGUYENHIEP.Models.tblNew>" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="UpperMainContent" runat="server">
    ...
    <%Html.RenderPartial("ViewRecruitment",ViewData); %>
    <input type="hidden" id="SelectedMenuId" name="SelectedMenuId" value="4" />
    </div>
</asp:Content>
