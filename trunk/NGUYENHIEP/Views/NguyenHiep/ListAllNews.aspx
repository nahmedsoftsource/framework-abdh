            ...
            <div class="boxCtentSpCtent">
                <div class="textLeft">
                    ...
                    <div class="paddingTb4 bold">
                        ...
                        <%=Html.ActionLink(item.TitleEN, "ViewNews", new { newsID = item.ID, type = NguyenHiep.Common.NewsTypes.News }, new { @class = "color2" })%>
                        <%}
                          else
                          { %>
                        <%if (String.IsNullOrEmpty(item.TitleVN)) item.TitleVN = Resources.Global.NoTitle; %>
                        <%=Html.ActionLink(item.TitleVN, "ViewNews", new { newsID = item.ID, type = NguyenHiep.Common.NewsTypes.News }, new { @class = "color2" })%>
                        <%} %>
                    </div>
                    <p>
                        <%--<a class="color1" href="#">--%>
