...
namespace ABDHFramework.Utility.ActionFilter
{
    public class SetCultureAttribute : FilterAttribute, IActionFilter
    {
        ...
        {
            IList<string> Cultures = new List<string> {"en-US", "vi-VN"};
            ...
            if (string.IsNullOrEmpty(CookieValue))
            {
                ...
                if (string.IsNullOrEmpty(SessionValue))
                {
                    ...
                    return string.IsNullOrEmpty(BrowserCulture) ? "vi-VN" : BrowserCulture;
                }
                return SessionValue;
            }
            return CookieValue;
